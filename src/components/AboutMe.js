...
function AboutMe() {
  return (
    <div className="h-screen flex items-center snap-start min-[320px]:flex-col min-[320px]:text-center min-[320px]:mt-[50px]">
      <div
        id="left"
        className="relative flex flex-1 items-center justify-center h-full "
      >
        <div id="card-bg" className="absolute w-[60%] h-70v left-[50px] top-[50px] bg-gray-800 rounded-[30px] min-[320px]:hidden"></div>

        <div id="card" className="w-[60%] h-70v relative min-[320px]:h-30v min-[320px]:w-full  ">
          <img
      ...
      <div id="right" className="flex-1 ">
        <h1 className="font-bold text-6xl min-[320px]:pb-[30px]">About Me</h1>
